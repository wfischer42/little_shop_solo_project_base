...
RSpec.describe 'Admin Stats' do
  context 'as an admin, viewing my dashboard' do
    before(:each) do
      ...
      create(:fulfilled_order_item, order: @order_1, inventory_item: @inventory_item_1)
      @order_2 = create(:completed_order, user: @user_1)
      create(:fulfilled_order_item, order: @order_2, inventory_item: @inventory_item_1)
      @order_3 = create(:completed_order, user: @user_1)
      create(:fulfilled_order_item, order: @order_3, inventory_item: @inventory_item_1)
      # Los Angeles, California is 1st place
      @order_4 = create(:completed_order, user: @user_2)
      create(:fulfilled_order_item, order: @order_4, inventory_item: @inventory_item_1)
      @order_5 = create(:completed_order, user: @user_2)
      create(:fulfilled_order_item, order: @order_5, inventory_item: @inventory_item_1)
      @order_6 = create(:completed_order, user: @user_2)
      create(:fulfilled_order_item, order: @order_6, inventory_item: @inventory_item_1)
      @order_7 = create(:completed_order, user: @user_2)
      create(:fulfilled_order_item, order: @order_7, inventory_item: @inventory_item_1)
      # Sorry Tampa, Florida
      @order_8 = create(:completed_order, user: @user_3)
      create(:fulfilled_order_item, order: @order_8, inventory_item: @inventory_item_1)
      # NYC, NY is 3rd place
      @order_9 = create(:completed_order, user: @user_4)
      create(:fulfilled_order_item, order: @order_9, inventory_item: @inventory_item_1)
      @order_A = create(:completed_order, user: @user_4)
      create(:fulfilled_order_item, order: @order_A, inventory_item: @inventory_item_1)
    end
